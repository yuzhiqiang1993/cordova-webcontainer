cordova.define("org.apache.cordova.geolocation.geolocation", function (require, exports, module) {
    ...
    module.exports = {
        getCurrentPosition: function (success, error, args) {
            console.log('[geolocation.js] getCurrentPosition called. Requesting Android system permission via exec...');
            const win = function (deviceApiLevel) {
                console.log('[geolocation.js] exec win callback received from Native. Android system permission granted.');
                ...
                console.log('[geolocation.js] Calling original navigator.geolocation.getCurrentPosition (WebView Native)...');
            ...
            const fail = function () {
                console.log('[geolocation.js] exec fail callback received from Native. Android system permission denied.');
                if (error) {
                    error(new PositionError(PositionError.PERMISSION_DENIED, 'Illegal Access'));
                }
            };
            const enableHighAccuracy = typeof args === 'object' && !!args.enableHighAccuracy;
            console.log('[geolocation.js] Executing cordova.exec("Geolocation", "getPermission")...');
